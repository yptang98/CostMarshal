...
REQUIRED_LOCAL_TESTS = (
    ...
    "tests/codex_native_contract_test.py",
    "tests/leader_policy_contract_test.py",
    ...
    "tests/result_attempt_output_binding_test.py",
    "tests/work_graph_contract_test.py",
    "tests/quality_gate_test.py",
    "tests/evolution_memory_test.py",
    ...
    "tests/three_tier_required_integration_test.py",
    ...
    "tests/route_budget_envelope_test.py",
    "tests/budget_reconciliation_oracle_test.py",
    "tests/project_success_policy_test.py",
    "tests/profile_binding_contract_test.py",
    "tests/escalation_replay_contract_test.py",
