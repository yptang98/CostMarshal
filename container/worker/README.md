...
The Dockerfile intentionally relies on the reviewed builder's bundled frontend
...
Release maintainers run the live evidence harness from a full source checkout,
not from the curated installed-plugin snapshot, with a locally available
reviewed image:
